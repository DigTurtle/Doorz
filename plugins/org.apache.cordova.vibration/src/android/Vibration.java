...
public class Vibration extends CordovaPlugin {
     ...
     *
     * @param pattern Pattern with which to vibrate the device. Pass in an array
     * of longs that are the durations for which to turn on or off the vibrator
     * in milliseconds. The first value indicates the number of milliseconds to
     * wait before turning the vibrator on. The next value indicates the number
     * of milliseconds for which to keep the vibrator on before turning it off.
     ...
     * repeating, or -1 for no repetition (default).
     */
