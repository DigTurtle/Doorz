...
public class FileUtils extends CordovaPlugin {
     ...
     * @param newName for the file directory to be called, if null use existing
     * file name
    ...
    /**
     * Returns a JSON object representing the given File. Internal APIs should
     * be modified to use URLs instead of raw FS paths wherever possible, when
     ...
     * only used by FileTransfer, and because it is a static method that should
     * really be an instance method, since it depends on the actual filesystem
     * roots in use. Internal APIs should be modified to use URLs instead of raw
     * FS paths wherever possible, when interfacing with this plugin.
     *
     * @param file the File to convert
     * @return a JSON representation of the given File
     * @throws JSONException
    ...
    /**
     * Read the contents of a file. This is done in a background thread; the
     * result is sent to the callback.
     *
     ...
     * UTF-8. (see http://www.iana.org/assignments/character-sets)
